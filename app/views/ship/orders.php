<body id="page-top">
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="card border-0">
                        <img src="<?= BASEURL; ?>/public/img/<?= $data['res']['ships']['gambar']; ?>" alt="" class="img-fluid card-singgle-order-img" style="height: 400px;" />
                        <div class="card-body">
                            <p>Kapal</p>
                            <h3 class="card-title"><?= $data['res']['ships']['kelas_pelayaran']; ?> - <?= $data['res']['ships']['maskapai_pelayaran']; ?></h3>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="row justify-content-center">
                        <div class="col-xxl-3 col-xl-3 col-md-3">
                            <div class="card border-0">
                                <img src="<?= BASEURL; ?>/public/img/<?= $data['res']['ships']['gambar']; ?>" alt="" class="img-fluid card-singgle-order-img" />
                                <div class="card-body">
                                    <h6 class="card-title text-center"><?= $data['res']['ships']['maskapai_pelayaran']; ?></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-9 col-xl-9 col-md-9">
                            ...
                            <div class="row justify-content-center mt-3">
                                <div class="col-xl-10 col-md-10 col-12">
                                    <div class="card-body">
                                        <h5><?= $data['res']['ships']['kelas_pelayaran']; ?> - <?= $data['res']['ships']['maskapai_pelayaran']; ?></h5>
                                        <hr />
                                        <p><i class="fa fa-wifi mx-2" aria-hidden="true"></i> Wifi</p>
                                        <p><i class="fa fa-bed mx-2" aria-hidden="true"></i> Kasur</p>
                                        <p><i class="fa fa-bath mx-2" aria-hidden="true"></i> Toilet</p>
                                ...
                                <div class="col-xl-2 col-md-2 col-12 d-flex align-items-center justify-content-center">
                                    <a href="<?= BASEURL; ?>/ships/orders/<?= $data['res']['ships']['id_pelayaran']; ?>" class="btn btn-primary" data-toggle="modal" data-target="#editModal<?= $data['res']['ships']['id_pelayaran']; ?>">Order</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- ============= Modal area ============= -->
    <!-- edit modal -->
    <div class="modal" id="editModal<?= $data['res']['ships']['id_pelayaran']; ?>" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= BASEURL; ?>/invoice/ships/<?= $data['res']['ships']['id_pelayaran']; ?>" method="post">
                        <input type="hidden" name="id_pelayaran" value="<?= $data['res']['ships']['id_pelayaran']; ?>" />
                        <input type="hidden" name="id_user" value="<?= $_SESSION['user_session']; ?>" />
                        <div class="form-group">
                            <!-- <label for="message-text" class="col-form-label">Gambar</label> -->
                            <img src="<?= BASEURL; ?>/public/img/<?= $data['res']['ships']['gambar']; ?>" alt="" width="48">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="recipient-name" name="harga" value="<?= $data['res']['ships']['harga']; ?>" readonly />
                        </div>
                </div>
