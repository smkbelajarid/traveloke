                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-6">
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            <img src="<?= BASEURL; ?>/public/img/<?= $data['rooms']['gambar']; ?>" alt="" class="img-fluid">
                                            <div class="row justify-content-center mt-3">
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 text-right">
                                                    <h6 class="font-weight-bold text-dark"><?= $data['rooms']['tipe_kamar']; ?></h6>
                                                    <h6 class="font-weight-bold text-dark"><?= $data['rooms']['deskripsi']; ?></h6>
                                                    <h6 class="font-weight-bold text-dark"><?= $data['rooms']['harga']; ?></h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
