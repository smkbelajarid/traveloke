                                    ...
                                    <div class="card card-list-container-user p-2">
                                        <a href="<?= BASEURL; ?>/ships/orders/<?= $res['id_pelayaran']; ?>" class="text-decoration-none text-dark">
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="card-body">
                                                        <h5 class="card-title"><?= $res['kelas_pelayaran'] ?> - <?= $res['maskapai_pelayaran']; ?></h5>
                                                        <p class="card-text">
