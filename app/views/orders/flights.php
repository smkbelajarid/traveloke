                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-6">
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            <img src="https://placekitten.com/g/1200/600" alt="" class="img-fluid">
                                            <div class="row justify-content-center mt-3">
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 text-right">
                                                    <h6 class="font-weight-bold text-dark"><?= $data['flights']['kelas_penerbangan']; ?></h6>
                                                    <h6 class="font-weight-bold text-dark"><?= $data['flights']['maskapai_penerbangan']; ?></h6>
                                                    <h6 class="font-weight-bold text-dark">Rp. <?= $data['flights']['harga']; ?>/hari</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
