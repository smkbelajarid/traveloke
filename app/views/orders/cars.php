                                ...
                                <div class="col-xl-6">
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Paket Pesanan</h6>
                                        </div>
                                        <div class="card-body">
                                            <img src="<?= BASEURL; ?>/public/img/<?= $data['cars']['image']; ?>" alt="" class="img-fluid">
                                            <div class="row justify-content-center mt-3">
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 text-right">
                                                    <h6 class="font-weight-bold text-dark"><?= $data['cars']['tipe_mobil']; ?></h6>
                                                    <h6 class="font-weight-bold text-dark"><?= $data['cars']['merk_mobil']; ?></h6>
                                                    <h6 class="font-weight-bold text-dark"><?= $data['cars']['jumlah_kursi']; ?></h6>
